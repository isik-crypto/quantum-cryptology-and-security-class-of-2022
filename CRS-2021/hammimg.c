...
{
	C[2] = M[0]; C[4] = M[1]; C[5] = M[2]; C[6] = M[3]; //This is encoding of (7,4) Hamming code using the generating matrix
	C[0] = ((M[0]^M[1])^M[3]);
	C[1] = (M[0]^M[2])^M[3];
	C[3] = (M[1]^M[2])^M[3];	
}
...
{
	char P[3], C[7];
	P[0] = ((C1[0]^C1[2])^C1[4])^C1[6];  P[1] = ((C1[1]^C1[2])^C1[5])^C1[6];  P[2] = ((C1[3]^C1[4])^C1[5])^C1[6];
